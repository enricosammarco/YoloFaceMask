...
model_path = "weights_and_anchors/tinyyoloep053.h5"
image_path = "imgReadme/img.jpg"

arg = {
    "model_path": model_path,
    "anchors_path": 'weights_and_anchors/tiny_yolo_anchors.txt',  # YOLOV3
...
save_path = image_path.replace(".jpg","_predicted.jpg")
